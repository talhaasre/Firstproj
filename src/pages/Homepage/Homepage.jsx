    ...
    <>
          ...
          <div className={`row ${styles.form_row}`}>
            <div className={`col-md-7 p-0 ${styles.form_col}`}>
              <div className={styles.form_fileds_wrapper}>
                ...
                <br />
                <h5 className={styles.title_hs_1}>Looking to publish your Ebook? Our team of expert formatters will make your ebook shine. Get in touch now!</h5>
                <br />
        ...
        <div className={styles.testimonials_div}>
          <div className={styles.testimonials_div_boxes}>
            ...
            <div className={styles.testimonials_div_box}>
              <p className={styles.testimonials_div_box_h}>Modern look & trending design</p>
      ...
      <section className={styles.guarantee}>
        <div className={styles.guarantee_div}>
          ...
          <div className={styles.guarantee_div_col}>
            ...
            <p className={styles.guarantee_div_col_p}>We stand behind our services with our 100% Satisfaction Guarantee. We genuinely want you to be happy with our work. If for any reason you don’t like something, we’ll work with you to make it right or we will refund your money. It’s that simple.</p>
            <div className={styles.guarantee_div_col_div}>
              <div className={styles.guarantee_div_col_div_1}>
                ...
                <p className={styles.guarantee_div_col_div_1_p}>48 Hour Delivery</p>
              ...
              <div className={styles.guarantee_div_col_div_1}>
                ...
                <p className={styles.guarantee_div_col_div_1_p}>Unlimited Revisions</p>
              ...
              <div className={styles.guarantee_div_col_div_1}>
                ...
                <p className={styles.guarantee_div_col_div_1_p}>Get Accepted To Amazon. Fast.</p>
      ...
      <section className={styles.footer}>
        ...
        <div className={styles.footerdiv_top}>
          ...
          <p className={styles.footerdiv_p}>All rights reserved. <span className={styles.footerdiv_span}>Terms and conditions</span></p>
        </div>
      </section>
      <hr />
